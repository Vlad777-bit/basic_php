...
<head>
    ...
    <title>Electra Café Moto Go! (2020)</title>
...
<div class="container">
    ...
    <div class="content content_product">
        <h1>Electra Café Moto Go! (2020)</h1>
        <a href="../public/img/bike1.jpg" target="_blank"><img src="../public/img/bike1.jpg" alt="bike" class="img"></a>
        <div class="text">
            
            <h3 class="header">Описание товара</h3>
            
            Новинка 2020 года&nbsp;&mdash; <i>Cafe Moto Go!</i> Велосипед олицетворяет будущее с&nbsp;историей.
            Вдохновленный скоростными каферейсерами, он&nbsp;сохранил в&nbsp;себе любовь к&nbsp;гонкам и&nbsp;дерзкий
            дизайн
            60-х годов.
            Современные компоненты от&nbsp;мировых производителей, скорость и&nbsp;бесшумность.
            Лимитированная коллекция, всего 10&nbsp;штук в&nbsp;России.
            <br>
            <a href="#">Купить</a>
        </div>
        ...
        <div class="text2">
            ...
            <b>Электровелосипед</b> <i>Caf&eacute; Moto Go!</i> (2020)&nbsp;&mdash; стильная модель для ценителей
            отличной
            электровелотехники.
