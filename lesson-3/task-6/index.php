<?php
	...
	$menu = [
		...
		'archive' => [
			'link' => '#',
			'submenu' => ['archive1', 'archive2', 'archive3'],
		], 

		'contact' => [
			'link' => '#',
			'submenu' => ['contact1', 'contact2', 'contact3'],
		]
	];
?>
...
<body>
	<div id="content">
			...
			<?php 
				function renderMenu($arr) {
					...
					foreach($arr as $key => $val) {
						print_r("<li><a href=" . $val['link'] . ">$key</a></li>");
					}
				}
		...
		<div id="footer">
		      <p>Copyright <?= $year; ?> &copy; <em>minimalistica</em> &middot; Design: Luka Cvrk, <a href="http://www.solucija.com/" title="Free CSS Templates">Solucija</a></p>
		</div>	
	</div>
</body>
</html>